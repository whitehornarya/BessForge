...
export function quantizeDxfNumber(value) {
    if (!Number.isFinite(value))
        throw new Error(`DXF numeric value must be finite: ${value}`);
...
export function quantizedPointKey(point) {
