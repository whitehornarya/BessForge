...
export const LEGACY_PROFILE_ID = 'legacy-eci-90';
export const LEGACY_TEMPLATE_ID = LEGACY_PROFILE_ID;
export const LEGACY_TEMPLATE_LABEL = 'Legacy';
export const LEGACY_PAGE_ROLE = 'page-2-legacy-bess-layout';
export const LEGACY_V1_CALIBRATION_PROFILE = 'legacy-v1';
export const CAR_D_B005_1_CALIBRATION_PROFILE = 'car-d-b005-1';
...
export const CABLE_CLASSES = Object.freeze([
...
export const TRENCH_CLASSES = Object.freeze([
    'mvac', 'dc', 'aux-fiber',
]);
...
export const CABLE_LAYER = Object.freeze({
...
export const TRENCH_LAYER = Object.freeze({
