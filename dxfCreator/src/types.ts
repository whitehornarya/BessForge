...
export type LegacyTemplateBuildOptions =
  Omit<LegacyBuildOptions, 'calibrationProfile'>;

export type LegacyTemplateInputSource =
  LegacyLayoutInput | (() => LegacyLayoutInput);
...
export type LegacyTemplateExportResult =
  | Readonly<{ handled: false }>
  | Readonly<{ handled: true; artifact: LegacyExportArtifact }>;
...
export type ValidationResult =
  | { ok: true; value: LegacyLayoutInput }
